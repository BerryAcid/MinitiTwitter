...
public class MyTweetRecyclerViewAdapter extends RecyclerView.Adapter<MyTweetRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTweetRecyclerViewAdapter(Context contexto, List<Tweet> items) {
        ...
        tweetViewModel = ViewModelProviders.of((FragmentActivity) contexto).get(TweetViewModel.class);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        if (mValues != null) {
            ...
            Glide.with(context)
                    ...
                    .into(holder.ivLike);
            holder.tvLikesCount.setTextColor(context.getResources().getColor(R.color.black));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            tvLikesCount = view.findViewById(R.id.textViewLike);
        }
